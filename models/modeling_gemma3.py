...
# https://github.com/huggingface/transformers/blob/v4.52.3/src/transformers/models/gemma3/modeling_gemma3.py#L779
...
class Gemma3DecoderLayer(nn.Module):
    def __init__(self, config: Gemma3TextConfig, layer_idx: int):
        ...
        self.identiy = nn.Identity()  # Identity layer responsible for residual stream before attention
        self.identiy_attn = nn.Identity() # Identity layer for residual stream after attention
        self.identiy_mlp2 = nn.Identity() # Identity layer for residual stream after second mlp
    ...
    def forward(
        ...
        **kwargs,
        ...
        residual = self.identity(residual) # Identity layer responsible for residual stream before attention
        ...
        residual = hidden_states
        residual = self.identiy_attn(residual) # Identity layer for residual stream after attention
        ...
        hidden_states = self.identiy_mlp2(hidden_states) # Identity layer for residual stream after second mlp
