...
def plot_steering_results(
    ...
    *,
    ...
    if savepath is None:
        ...
        os.makedirs(f"/home/fe/purelku/Desktop/Master_thesis/results_steering_datasets_adaptive/{safe_model_name}", exist_ok=True)

        savepath = f"/home/fe/purelku/Desktop/Master_thesis/results_steering_datasets_adaptive/{safe_model_name}/steering_toxicity_{safe_model_name}_datasets_{t}"
...
def plot_steering_deltas(
    ...
    *,
    ...
    if savepath is None:
        os.makedirs(f"/home/fe/purelku/Desktop/Master_thesis/results_steering_datasets_adaptive/{safe_model_name}", exist_ok=True)
        savepath = f"/home/fe/purelku/Desktop/Master_thesis/results_steering_datasets_adaptive/{safe_model_name}/steering_toxicity_deltas_{safe_model_name}_datasets_{t}"
...
def main(args):
    ...
    for i, layer in enumerate(layers):
        ...
        print(f"Loaded alphas from {load_alpha}: {alphas.shape}")
        alpha_pos = t
        alpha_neg = t
        labels_after_harmbench=np.load(f"{args.output_dir}/{safe_model_name}/labels_steering_{side}_alpha_n_{alpha_neg}_{layer}.npy", allow_pickle=True).item()
        ...
        labels_after_harmbench_pos=np.load(f"{args.output_dir}/{safe_model_name}/labels_steering_{side}_alpha_{alpha_pos}_{layer}.npy", allow_pickle=True).item()
    ...
    for data in args.dataset:
        ...
        for i, layer in enumerate(layers):
            ...
            labels_after_d=np.load(f"{args.output_dir}/{safe_model_name}/labels_steering_{side}_alpha_n_{alpha_neg}_{safe_dataset}_{layer}.npy", allow_pickle=True).item()
