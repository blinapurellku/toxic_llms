...
def plot_steering_results(
    ...
    *,
    ...
    if savepath is None:
        ...
        savepath = f"/home/fe/purelku/Desktop/Master_thesis/results_ablation_plot/{safe_model_name}/steering_toxicity_{safe_model_name}_datasets_{t}_1"
...
def plot_steering_deltas(
    ...
    *,
    ...
    if savepath is None:
        os.makedirs(f"/home/fe/purelku/Desktop/Master_thesis/results_ablation_plot/{safe_model_name}", exist_ok=True)
        savepath = f"/home/fe/purelku/Desktop/Master_thesis/results_ablation_plot/{safe_model_name}/steering_toxicity_deltas_{safe_model_name}_datasets_{t}_1"
...
if __name__ == "__main__":
    args = parse_args()
    for _, model in enumerate(["google/gemma-2-2b", "google/gemma-2-2b-it", "allenai/OLMo-2-0425-1B-Instruct", "allenai/OLMo-2-0425-1B","Qwen/Qwen2.5-3B","Qwen/Qwen2.5-3B-Instruct",  "meta-llama/Llama-3.2-3B-Instruct", "meta-llama/Llama-3.2-3B"]): #"google/gemma-2-2b-it", , "allenai/OLMo-2-0425-1B-SFT", "allenai/OLMo-2-0425-1B-DPO"
        #  
        args.model = model
        args.t = 1
