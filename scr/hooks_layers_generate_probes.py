...
def main(args):
    ...
    model, tokenizer = load_model_and_tokenizer(args.model, bnb_config=args.bnb_config)
    ...
    dataset = load_dataset("unalignment/toxic-dpo-v0.2", split="train", token=os.getenv("HUGGINGFACEHUB_API_TOKEN"), cache_dir="/hf")
