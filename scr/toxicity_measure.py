...
USE_BASE_MODEL = True  # Set to True if you want to use the base model instead of the instruct model
...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="google/gemma-2-2b") #"google/gemma-3-1b-it")
