...
def main(args):
    ...
    if args.dataset == "walledai/HarmBench":
        ...
        if atten:
            ...
            print(all_states[list(all_states.keys())[0]].shape)
...
if __name__ == "__main__":
    ...
    # models = ["google/gemma-2-2b", "meta-llama/Llama-3.2-3B","Qwen/Qwen2.5-3B","allenai/OLMo-2-0425-1B" ]
    datasets = ["walledai/AdvBench","walledai/DTStereotype", "walledai/CatHarmfulQA","walledai/DTToxicity", "truthfulqa/truthful_qa"] #"walledai/HarmBench",
                 # 
    for model in models:
